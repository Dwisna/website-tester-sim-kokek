<div class="floating-chat" id="floating-chat">
    ...
    <button type="button" class="floating-chat-toggle btn btn-primary d-flex align-items-center justify-content-center" id="floating-chat-toggle" aria-label="Buka chat">
        <span class="icon-wrap">@include('components.ui.icon', ['name' => 'message', 'size' => 20])</span>
    </button>
</div>
